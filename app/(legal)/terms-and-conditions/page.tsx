...
export const metadata: Metadata = {
  ...
  description:
    "Read Nepal Pest Control Kathmandu's Terms and Conditions. Understand the terms of use for our website and services, including user rights, intellectual property, and legal agreements.",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Terms & Conditions - Nepal Pest Control Kathmandu",
    description:
      "Read Nepal Pest Control Kathmandu's Terms and Conditions. Understand the terms of use for our website and services.",
  ...
  twitter: {
    card: "summary",
    title: "Terms & Conditions - Nepal Pest Control Kathmandu",
    description: "Nepal Pest Control Kathmandu's Terms and Conditions",
  },
  alternates: {
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-5xl">
        ...
        <div className="prose prose-lg text-gray-500 max-w-none">
          ...
          <p className="mb-8">
            ...
            (&quot;you&quot;) and Nepal Pest Control Kathmandu (&quot;we,&quot;
          ...
          <p className="mb-8">
            ...
            United States. Nepal Pest Control Kathmandu and yourself irrevocably consent
