...
export const metadata: Metadata = {
  title: "Blog",
  description:
    "Stay informed with the latest insights from Nepal Pest Control Kathmandu. Read our expert articles on pest control services, pest control best practices, and industry trends.",
};
